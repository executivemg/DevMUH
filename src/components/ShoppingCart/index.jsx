            ...
            <div className="grid lg:grid-cols-3">
                <div className="lg:col-span-2 p-10 bg-black overflow-x-auto">
                    <div className="flex border-b pb-4">
                        <h2 className="text-4xl font-extrabold flex-1 text-transparent bord">Shopping Cart</h2>
                    </div>
                    <div>
                                            ...
                                            <td className="py-6 px-4">
                                                <div className="flex items-center gap-6 w-max">
                                                    ...
                                                    <div className="flex items-center gap-1 mt-4">
                                                        ...
                                                        <button
                                                            onClick={() => handleRemoveFromCart(item.interestedInCustomDomain)}
                                                            type="button"
                ...
                <div className="bg-black p-10">
                    <h3 className="text-xl font-extrabold border-b pb-4">Order Summary</h3>
