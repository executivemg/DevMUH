...
const ItemAppendForm = () => {
  ...
  return (
    <div className={`fixed right-0 ${openDrawer? 'translate-x-0 bg-black/80 w-screen ' : 'translate-x-[12rem]'} transition-all ease-in-out duration-[0.5s] z-[10] flex justify-end h-full shadow-[0_2px_3px_5px_rgba(44,59,250,0.1)] rounded-l-[8px] `}>
